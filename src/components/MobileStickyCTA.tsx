  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 md:hidden bg-white border-t border-gray-200 shadow-[0_-4px_20px_rgba(0,0,0,0.1)] safe-area-bottom">
      <div className="flex items-center gap-2 p-3">
        <a
          href="tel:3437000770"
          className="flex-1 flex items-center justify-center gap-2 py-3.5 rounded-xl font-bold text-[#110a0c] bg-gray-100 active:bg-gray-200 transition-colors touch-manipulation"
        >
        ...
        <Link
          href="/contact"
          className="flex-1 flex items-center justify-center gap-2 py-3.5 rounded-xl font-bold text-white bg-[#f04d22] active:bg-[#d63d15] transition-colors shadow-lg shadow-[#f04d22]/25 touch-manipulation"
        >
