...
export default function Footer() {
  ...
  return (
    <footer className="bg-white">
        ...
        <div className="container-custom">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-start">
            ...
            <div>
              ...
              {/* Contact Info - Large touch targets */}
              <div className="space-y-3">
                <a href="tel:3061231234" className="flex items-center gap-3 text-[#4a4a4a] hover:text-[#0d9488] active:text-[#0d9488] transition-colors py-3 -my-2 touch-manipulation min-h-[48px]">
                  ...
                  <span className="font-semibold text-base">(306) 123-1234</span>
                </a>
                <a href="mailto:info@bisonproperties.ca" className="flex items-center gap-3 text-[#4a4a4a] hover:text-[#0d9488] active:text-[#0d9488] transition-colors py-3 -my-2 touch-manipulation min-h-[48px]">
                  <svg className="w-5 h-5 text-[#0d9488] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  <span className="text-base">info@bisonproperties.ca</span>
                </a>
              </div>
            </div>
      ...
      {/* Bottom Bar - Extra padding on mobile for sticky CTA */}
      <div className="bg-black text-white py-6 sm:py-6 px-4 sm:px-6 pb-28 md:pb-6">
        <div className="container-custom">
          <div className="flex flex-col gap-5 sm:gap-0 sm:flex-row sm:justify-between sm:items-center">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4">
              <Link href="/" className="flex items-center gap-2 touch-manipulation min-h-[48px]">
                <svg
                ...
                <span className="font-bold text-white text-base">BISON PROPERTIES</span>
              </Link>
            </div>

            <p className="text-gray-400 text-sm text-center sm:text-left order-last sm:order-none">
            ...
            <div className="flex items-center justify-center sm:justify-end gap-3">
              <a
                ...
                className="w-12 h-12 sm:w-10 sm:h-10 flex items-center justify-center rounded-full bg-white/10 hover:bg-[#0d9488] active:bg-[#0d9488] active:scale-95 text-white transition-all duration-200 touch-manipulation"
