        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="relative order-2 lg:order-1">
            ...
            <div className="relative">
              <div className="aspect-[4/4] sm:aspect-[4/5] bg-gradient-to-br from-[#110a0c] to-[#1a1315] rounded-2xl md:rounded-3xl overflow-hidden shadow-2xl">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center p-6 md:p-8">
                    <div className="w-20 h-20 md:w-28 md:h-28 bg-[#f04d22]/20 rounded-full flex items-center justify-center mx-auto mb-4 md:mb-6">
                      <svg className="w-10 h-10 md:w-14 md:h-14 text-[#f04d22]" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* Floating elements */}
              <div className="absolute -top-4 -left-4 md:-top-6 md:-left-6 bg-[#f04d22] rounded-xl md:rounded-2xl p-4 md:p-6 shadow-xl shadow-[#f04d22]/25">
                <div className="text-2xl md:text-4xl font-black text-white">500+</div>
                <div className="text-white/80 font-semibold text-sm md:text-base">Properties</div>
              </div>
              ...
              <div className="absolute -bottom-4 -right-4 md:-bottom-6 md:-right-6 bg-white rounded-xl md:rounded-2xl p-4 md:p-6 shadow-xl border border-gray-100">
                <div className="flex items-center gap-2 md:gap-3">
                  <div className="flex -space-x-1.5 md:-space-x-2">
                    {[...Array(4)].map((_, i) => (
                      <div key={i} className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-gradient-to-br from-[#110a0c] to-[#1a1315] border-2 border-white flex items-center justify-center">
                  ...
                  <div>
                    <div className="font-bold text-[#110a0c] text-sm md:text-base">100%</div>
          ...
          <div className="order-1 lg:order-2">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-[#110a0c] mb-5 md:mb-6 leading-tight">
              Client Focused,
              <span className="text-[#f04d22]"> Results Driven</span>
            </h2>
            ...
            <p className="text-gray-600 mb-8 md:mb-10 leading-relaxed text-sm md:text-base">
              Our team is committed to delivering exceptional results with attention to detail. We believe in honest communication, fair pricing, and building long-term relationships with our clients. When you work with Bison, you&apos;re working with a team that genuinely cares.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-5 mb-8 md:mb-10">
              {[
                ...
                <div key={index} className="flex items-start gap-3 md:gap-4 p-3 md:p-4 bg-white rounded-xl md:rounded-2xl border border-gray-100 shadow-sm">
                  <div className="w-10 h-10 md:w-11 md:h-11 rounded-lg md:rounded-xl bg-[#110a0c] flex items-center justify-center flex-shrink-0">
                    <svg className="w-5 h-5 text-[#f04d22]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d={item.icon} />
                    </svg>
                  </div>
                  <div>
                    <h4 className="font-semibold text-[#110a0c] text-sm md:text-base">{item.title}</h4>
